...
<body>
    <div class="bx graphpaper">
        <h2>From Julius Abanel</h2>
        <p class="left">
            To our beloved professor, Engr. Robert Chaves.
            <br /> <br />
            One of the professors in Bulacan State University na balance in all things. Magaling magturo (lalo ma programming) maiintindihan mo talaga and mostly practical yung tinuturo. May concern sa students, hindi mas'yadong pinahihirapan students as long as natututo naman and nagagawa nga naming mga students 'yon dahil sa'yo Sir! One of the professors na hindi ko makakalimutan personally.  Kung magiging prof ako in the future, kayo magiging standard ko Sir.
            <br /><br />
            Thank you sa pagtuturo sa'ming lahat ng buong puso. ❤️
        </p>
      </div>
</body>
</html>