    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                ...
                <p class="w-lg-50">Write whatever on your mind 😀</p>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <form action="/blogs" method="post" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-dark btn-sm" type="submit" style="font-size: 12px;padding: 8px 25px;margin-top: 8px;text-align: justify;">POST</button>
                </form>
